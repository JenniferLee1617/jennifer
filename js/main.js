...
$(document).ready(function () {
	$('.j-filter .p-list').click(function () {
		$(this).addClass("active").siblings().removeClass("active");
		let idx = $(this).index();
		$(".dropdown .p-list").eq(idx).addClass("active").siblings().removeClass("active");
...
$(document).ready(function () {
	$('.dropdown .p-list').click(function () {
		$(this).addClass("active").siblings().removeClass("active");
		let idx = $(this).index();
		$(".j-filter .p-list").eq(idx).addClass("active").siblings().removeClass("active");
...
$(".view-my-portfolio").click(function () {
	$(".j-filter .p-list:nth-of-type(1)").addClass("active").siblings().removeClass("active")
	$(".dropdown .p-list:nth-of-type(1)").addClass("active").siblings().removeClass("active")
...
var animateReveal = function () {
	...
	setTimeout(function () {
		...
		// 홈-오토타이핑
		var typed = new Typed(".auto-typed", {
			strings: ["Designer", "Developer", "Video Editor", "Freelancer"],
			typeSpeed: 150,
			// onBegin: () => {},
			// startDelay: 500,
			backSpeed: 150,
